...
function AddEditTransaction(props) {
  const {showAddEditTransactionModal, 
  ...
  const [formData, setFormData] = useState({
    amount: "",
    type: "",
    // type: isEditing ? selectedItemForEdit.transaction.type : "",
    category: "",
    date: undefined,
    // date: Date.now(),
    reference:  "",
  ...
  // const [formData, setFormData] = useState({
  //   amount: isEditing ? selectedItemForEdit.transaction.amount : "",
  //   type: "expense",
  //   // type: isEditing ? selectedItemForEdit.transaction.type : "",
  //   category: isEditing ? selectedItemForEdit.transaction.category : "",
  //   date: isEditing ? (selectedItemForEdit.transaction.date): undefined,
  //   // date: Date.now(),
  //   reference: isEditing ? selectedItemForEdit.transaction.reference : "",
  //   description: isEditing ? selectedItemForEdit.transaction.description : "",
  // })
  ...
  return (
    ...
    <Modal show={showAddEditTransactionModal} onHide={handleHide}>
    <Modal.Header closeButton >
      <Modal.Title>勘定項目の追加</Modal.Title>
    </Modal.Header>
